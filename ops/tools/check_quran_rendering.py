...
EN_CONTENT_GLOBS = (
    ...
    # وحدات قاعدة المعرفة المترجمة (`<id>__en`). غيابها هنا كان ثغرة صامتة:
    # الفحص مرّ بـ✅ على ٤٢٦ ملفًا بينما ٥٤٨ وحدة إنجليزية جديدة لم تُقرأ أصلًا،
    # وهذا بالضبط «نجاح شكله نجاح ولم ينظر». التغطية تُوسَّع، ولا تُضيَّق.
    "knowledge_base/units/*__en.json",
