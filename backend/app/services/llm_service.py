...
def _build_prompt(
    ...
    if variant == "rich":
        ...
        user_prompt += (
            f"تعليمات الرد:\n"
            f"1. أجب مباشرةً عن سؤال الوالد بالتحديد، ثم خطوات عملية مرقّمة.\n"
            f"2. {length_rule}\n"
            f"3. اعتمد على المصادر أعلاه كمرجع أساسي. إن لم تغطِّ المصادر "
            f"السؤال مباشرةً، قدّم إرشاداً تربوياً سلوكياً عاماً وآمناً يجيب عن "
            f"السؤال فعلاً — لكن لا تخترع أبداً معلومة طبية أو رقماً أو تشخيصاً "
            f"أو دواءً أو حكماً شرعياً غير وارد في المصادر.\n"
