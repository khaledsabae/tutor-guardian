...
_AYAH_BY_TEXT: dict[str, tuple[int, int]] = {
    ...
    # آية الدين — البقرة 282 (طويلة، overlap ratio بيفشل)
    "يا ايها الذين امنوا اذا تداينتم بدين الى اجل مسمي": (2, 282),
    "اذا تداينتم بدين": (2, 282),
    # البقرة 286
    "لا يكلف الله نفسا الا وسعها": (2, 286),
    # آية الكرسي تانية بالنص الصريح
    "الله لا اله الا هو الحي القيوم": (2, 255),
    # الحجرات 12 — الغيبة
    "يا ايها الذين امنوا اجتنبوا كثيرا من الظن": (49, 12),
    "اجتنبوا كثيرا من الظن": (49, 12),
    # الإسراء 23 — بر الوالدين
    "وقضي ربك الا تعبدوا الا اياه وبالوالدين احسانا": (17, 23),
    # المائدة 8 — العدل
    "يا ايها الذين امنوا كونوا قوامين لله شهداء بالقسط": (5, 8),
    "كونوا قوامين لله شهداء بالقسط": (5, 8),
    # الضحى 1
    "والضحي والليل اذا سجي": (93, 1),
    "والضحي": (93, 1),
    # النور 30 — غض البصر
