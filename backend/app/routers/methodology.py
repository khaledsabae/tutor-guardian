...
<p>كل إجابة يعطيها المربي مبنية على <strong>مصادر موثّقة</strong>، و<strong>مذكّر فيها المصدر</strong> في سطر خاص يبدأ بـ 📚. لا نخترع معلومات، ولا ن给出 فتاوى بدون سند.</p>

<h2>قاعدة المعرفة</h2>
<div class="stat-grid">
  <div class="stat">
    <div class="stat-num">١٬١٢٣</div>
    <div class="stat-label">وحدة معرفة</div>
  </div>
  <div class="stat">
    <div class="stat-num">٤٩٤</div>
    <div class="stat-label">وحدة شرعية</div>
  </div>
  <div class="stat">
    <div class="stat-num">٢٢٥</div>
    <div class="stat-label">وحدة سيبرانية</div>
  </div>
  <div class="stat">
    <div class="stat-num">١٩٢</div>
...
<ul>
  ...
  <li><strong>طبي (تطوّر الطفل):</strong> إرشادات النمو السلوكي والعقلي من مراجع طبية موثوقة</li>
</ul>

<h2>كيف يعمل المربي</h2>
<h3>١. البحث الدلالي (RAG)</h3>
<p>لما تسأل سؤالاً تربوياً، المربي يبحث في قاعدة المعرفة عن أقرب الوحدات المعرفية relacionada بسؤالك — باستخدام تقنية البحث الدلالي (Semantic Search) اللي بتفهم معنى سؤالك مش بس الكلمات.</p>
...
<ul>
  ...
  <li>لا نجمع بيانات شخصية م identifies</li>
...
""" % {"play": _PLAY}
    ...
    return _page(
        ...
        desc="كيف يضمن المربي الذكي أن إجاباته موثوقة ومبنية على مصادر شرعية وعلمية — قاعدة معرفة ١٬١٢٣ وحدة مع ضوابط أمان صارمة",
        body=body,
        canonical=canonical,
    )
