...
| **Keywords** | `صحة_نفسية`, `الإجهاد`, `القلق` |
| **Language** | en |
| **Severity** | متوسط |
...
```json
{
  ...
  "text_simplified": "يتطلب هذا التوضيح وصفًا موجزًا عن الصحة النفسية، مع التركيز على أهمية التعامل السليم مع الإجهاد والقلق وكيفية الحصول على المساعدة عند الحاجة.",
  "keywords": [
    "صحة_نفسية",
    "الإجهاد",
    "القلق"
