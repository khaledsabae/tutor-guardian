...
| **Keywords** | `ضعف التركيز`, `التركيز`, `الاستشارة الطبية` |
| **Language** | en |
| **Severity** | متوسط |
...
> عند الشعور بضعف التركيز، يُنصح بالتحدث مع الطبيب إذا استمرت المشاكل مدة طويلة.
...
```json
{
  ...
  "text_simplified": "عند الشعور بضعف التركيز، يُنصح بالتحدث مع الطبيب إذا استمرت المشاكل مدة طويلة.",
  "keywords": [
    "ضعف التركيز",
    "التركيز",
    "الاستشارة الطبية"
