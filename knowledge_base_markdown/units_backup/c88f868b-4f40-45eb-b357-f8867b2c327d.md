...
> ملف إرشادي طبي من Autism Milestones Checklist يتناول معلومات عن الحالة الصحية واستراتيجيات التعامل معها في سياق الأسر العربية.
...
```json
{
  ...
  "text_simplified": "ملف إرشادي طبي من Autism Milestones Checklist يتناول معلومات عن الحالة الصحية واستراتيجيات التعامل معها في سياق الأسر العربية.",
  "keywords": [],
