...
| **Keywords** | `ألعاب إلكترونية`, `إدمان الشاشة`, `الأهل` |
| **Language** | en |
| **Severity** | شديد |
...
> لاحظ بعض الأهل أن أولادهم يقضون ساعات طويلة في الألعاب الإلكترونية دون أن يستطيعوا التوقف، حتى لو أدى ذلك إلى تراجع الدراسة أو الخلافات العائلية. من العلامات المهمة استمرار الابن في اللعب رغم الضرر الذي يلحق بوقته الدراسي أو نومه وصحته. على الأهل وضع قواعد واضحة لوقت الشاشة منذ الصغر، وتشجيع هوايات بديلة، وطلب المساعدة من مختصين لو لاحظوا انسحاب الابن من الحياة اليومية أو تغيرًا حادًا في مزاجه.
...
```json
{
  ...
  "reference_info": "Bulletin of the World Health Organization 2019"
}
```
</details>
