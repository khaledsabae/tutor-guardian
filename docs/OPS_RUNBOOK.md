...
1. **الحد ≤ آخر بناء متاح بنسبة 100% على Play.** حدٌّ فوق ما يقدّمه Play (إصدار
   ...
   يمكن تنزيله. `plan` يرفض أي حد لا يعمل عليه (أو على أعلى منه) جهازٌ نشط في
   آخر 7 أيام؛ و`FORCE=1` يتخطى الفحص، ولا يُستخدم إلا بعد التأكد من Play Console.
2. **القرار بالأرقام.** `plan` يطبع نسبة من سيُجبَر على التحديث، ومنهم «unknown»
   (بناء أقدم من التعداد) لأنه تحت أي حد.

**التوصية:** 109 (1.0.64)، بشرط أن يكون منشورًا 100% على Play وقت التطبيق. فيه
إثبات الجهاز (106)، وتجديد التوكن (107)، وإصلاح الأزرار التي ظهرت بلا لون في
106/107 (108)، وUX-1. لا يُرفع إلى 111 إلا بعد اعتماده من جوجل وظهوره في التعداد.
