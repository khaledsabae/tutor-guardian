...
> **لخالد:** هذه حزمة البرومبتات المهيأة لـ **Google NotebookLM / Gemini Notebook** لتوليد الفيديوهات والإنفوجراف والبودكاست الخاص بمسار **«الحمل والمولود الجديد: رحلة الرعاية والسكينة»** (`path_prenatal-1_infant_pregnancy_foundations`).
