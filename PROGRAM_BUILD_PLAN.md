...
| 2026-06-11 | **تنظيف الأصول اليتيمة (Claude)** | ✅ | حذف 597 ملف من دفعة NotebookLM المعطوبة الميتة (بعد أن صار كل الدروس على `gen_*` النظيف): 292 فلاش يتيم + 35 كويز معطوب + 266 سلايد غير مربوط + 4 ملفات خرائط معطوبة. `lesson_assets` بقى فيه بس الـ59 فلاش + 59 كويز النظاف (+ المُشار إليه من reports/data_tables/infographics/podcasts/videos). الريبو نضيف 0 untracked. البوابات خضراء، الـresolver متحقَّق بعد الحذف، الإنتاج صحّي. (ملاحظة: 1.1GB blobs لسه في تاريخ git — مؤجّل لـpurge بعد تجديد التوكن.) commit b928939. |
